  ...
  <main>
    ...
    <section id="comments" class="container mx-auto mt-6">
      <div class="bg-white rounded border border-gray-200 relative flex flex-col">
        ...
        <div class="p-6">
          <div
            class="text-white text-center font-bold mb-4"
...
export default {
  ...
  async created() {
    const docSnaposhot = await songsCollection.doc(this.$route.params.id).get()
  ...
  methods: {
    ...
    async addComment(values, { resetForm }) {
      ...
      const comment = {
        ...
        datePosted: new Date().toString(), // Firebase does not accept dates
        sid: this.$route.id,
